...
private:
    ...
    void handle_ok_legacy_reply(uint16_t from_node, api::RemoveLocationReply& reply);
    void handle_ok_phase1_reply(uint16_t from_node, api::RemoveLocationReply& reply);
    void handle_ok_phase2_reply(uint16_t from_node, api::RemoveLocationReply& reply);
